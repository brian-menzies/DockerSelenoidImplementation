...
"""
A process for retrieving basic information from the running EC2 instances.
"""
...
TXTFILES_FOLDER = os.path.join(PROJECT_ROOT, 'Text_Files\\')
txt_path = TXTFILES_FOLDER + 'InstanceInfo.txt'
...
# Dictionaries to Use Once Loop is Completed
